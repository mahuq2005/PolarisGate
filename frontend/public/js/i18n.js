...
const T = {
  ...
  fr: {
    ...
    domainDesc: 'Définissez les niveaux de sévérité et actions pour la détection de toxicité et DPI.',
    ...
    blocklistDesc: 'Ajoutez des mots ou phrases à bloquer. Le contenu contenant ces mots sera bloqué.',
    addWord: 'Ajouter un Mot',
    remove: 'Supprimer',
    noBlockedWords: 'Aucun mot bloqué',
    wordAdded: 'Mot ajouté à la liste de blocage',
    wordRemoved: 'Mot retiré',
    auditDesc: 'Registre complet des décisions de sécurité, modifications de politiques et connexions.',
    noAuditLogs: 'Aucun journal d\'audit',
    hallucinationDetections: 'Détections d\'Hallucination',
    hallucinationDesc: 'Contenu IA signalé pour inexactitudes factuelles par le détecteur NLI à deux modèles.',
    ...
    keyCreated: 'Clé Créée — Copiez-la !',
  ...
  ar: {
    ...
    piiDetectedLabel: 'اكتشاف معلومات شخصية',
    yes: 'نعم',
    no: 'لا',
    noneFound: 'لم يتم العثور',
    promptInjection: 'حقن التوجيه',
    detectedScore: 'مكتشف',
    noneDetected: 'لم يتم الاكتشاف',
    blocklistedLabel: 'قائمة الحظر',
    blockedYes: 'نعم — محظور',
    piiTypesFound: 'أنواع المعلومات الشخصية',
    redactedOutput: 'الإخراج المنقح',
    unavailable: 'خدمة التحليل غير متاحة.',
    batchResults: 'نتائج الدفعة',
    tested: 'تم الاختبار',
    domainThresholds: 'عتبات سلامة المجال',
    domainDesc: 'تعيين مستويات الخطورة والإجراءات لكل مجال للسمية واكتشاف المعلومات الشخصية.',
    saveDomainThresholds: 'حفظ عتبات المجال',
    domainSaved: 'تم حفظ عتبات المجال',
    customBlocklist: 'قائمة حظر مخصصة',
    blocklistDesc: 'أضف كلمات مخصصة للحظر.',
    addWord: 'إضافة كلمة',
    remove: 'إزالة',
    noBlockedWords: 'لا توجد كلمات محظورة',
    wordAdded: 'تمت إضافة الكلمة',
    wordRemoved: 'تمت إزالة الكلمة',
    auditDesc: 'سجل كامل لجميع قرارات السلامة.',
    noAuditLogs: 'لا توجد سجلات تدقيق',
    hallucinationDetections: 'اكتشافات الهلوسة',
    hallucinationDesc: 'محتوى الذكاء الاصطناعي المبلغ عنه لعدم الدقة الواقعية.',
    noHallucinations: 'لا توجد اكتشافات هلوسة',
    userManagement: 'إدارة المستخدمين',
    userDesc: 'إدارة المستخدمين مع الوصول القائم على الدور.',
